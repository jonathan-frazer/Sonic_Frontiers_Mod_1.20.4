...
public class baseformModel_lightSpeed<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "baseformmodel_lightspeed"), "main");
	...
	public baseformModel_lightSpeed(ModelPart root) {
