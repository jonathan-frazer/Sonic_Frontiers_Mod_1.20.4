...
public class SonicFlatPlayerModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(BeyondTheHorizon.MOD_ID, "baseform/model_base"), "main");
	...
	public SonicFlatPlayerModel(ModelPart root) {
