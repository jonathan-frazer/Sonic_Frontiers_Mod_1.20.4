...
public class Spinslash<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(BeyondTheHorizon.MOD_ID, "baseform/spinslash"), "main");
	public static final ModModelRenderer.Texture[] TEXTURE_LOCATIONS = {
			new ModModelRenderer.Texture("textures/custom_model/baseform/spinslash/0.png",(byte)0),
			new ModModelRenderer.Texture("textures/custom_model/baseform/spinslash/1.png",(byte)1),
			new ModModelRenderer.Texture("textures/custom_model/baseform/spinslash/2.png",(byte)2),
			new ModModelRenderer.Texture("textures/custom_model/baseform/spinslash/3.png",(byte)3)
	};
	...
	public Spinslash(ModelPart root) {
