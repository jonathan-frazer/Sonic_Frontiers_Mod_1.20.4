...
public class HomingAttack<T extends Entity> extends EntityModel<T> {
	...
	public static final String TEXTURE_LOCATION = "textures/custom_model/homingattack.png";
	...
	public HomingAttack(ModelPart root) {
		this.hexadecagon_outer = root.getChild("hexadecagon_outer");
		this.hexadecagon_inner = root.getChild("hexadecagon_inner");
		this.hexadecagon_center = root.getChild("hexadecagon_center");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hexadecagon_outer = partdefinition.addOrReplaceChild("hexadecagon_outer", CubeListBuilder.create().texOffs(6, 27).addBox(-2.0F, -9.5913F, -8.0F, 2.0F, 3.1826F, 1.0F, new CubeDeformation(0.0F))
		...
		.texOffs(0, 15).addBox(-2.0F, -16.0F, -1.5913F, 2.0F, 1.0F, 3.1826F, new CubeDeformation(0.0F)), PartPose.offset(1.0F, 24.0F, 0.0F));

		PartDefinition hexadecagon_r1 = hexadecagon_outer.addOrReplaceChild("hexadecagon_r1", CubeListBuilder.create().texOffs(9, 12).addBox(-1.0F, -8.0F, -1.5913F, 2.0F, 1.0F, 3.1826F, new CubeDeformation(0.0F))
		...
		PartDefinition hexadecagon_r2 = hexadecagon_outer.addOrReplaceChild("hexadecagon_r2", CubeListBuilder.create().texOffs(16, 0).addBox(-1.0F, -8.0F, -1.5913F, 2.0F, 1.0F, 3.1826F, new CubeDeformation(0.0F))
		...
		PartDefinition hexadecagon_r3 = hexadecagon_outer.addOrReplaceChild("hexadecagon_r3", CubeListBuilder.create().texOffs(23, 4).addBox(-1.0F, -1.5913F, 7.0F, 2.0F, 3.1826F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition hexadecagon_r4 = hexadecagon_outer.addOrReplaceChild("hexadecagon_r4", CubeListBuilder.create().texOffs(25, 25).addBox(-1.0F, -1.5913F, 7.0F, 2.0F, 3.1826F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition hexadecagon_inner = partdefinition.addOrReplaceChild("hexadecagon_inner", CubeListBuilder.create().texOffs(0, 31).addBox(-9.0F, -8.9946F, 3.0F, 2.0F, 1.9891F, 1.0F, new CubeDeformation(0.0F))
		...
		.texOffs(0, 19).addBox(-9.0F, -13.0F, 7.0054F, 2.0F, 1.0F, 1.9891F, new CubeDeformation(0.0F)), PartPose.offset(8.0F, 24.0F, -8.0F));
		...
		PartDefinition hexadecagon_center = partdefinition.addOrReplaceChild("hexadecagon_center", CubeListBuilder.create().texOffs(8, 1).addBox(-9.0F, -8.3978F, 6.0F, 2.0F, 0.7956F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(13, 22).addBox(-9.0F, -10.0F, 7.6022F, 2.0F, 4.0F, 0.7956F, new CubeDeformation(0.0F)), PartPose.offset(8.0F, 24.0F, -8.0F));

		PartDefinition hexadecagon_r9 = hexadecagon_center.addOrReplaceChild("hexadecagon_r9", CubeListBuilder.create().texOffs(0, 22).addBox(-1.0F, -2.0F, -0.3978F, 2.0F, 4.0F, 0.7956F, new CubeDeformation(0.0F))
		...
		PartDefinition hexadecagon_r10 = hexadecagon_center.addOrReplaceChild("hexadecagon_r10", CubeListBuilder.create().texOffs(19, 22).addBox(-1.0F, -2.0F, -0.3978F, 2.0F, 4.0F, 0.7956F, new CubeDeformation(0.0F))
		...
		PartDefinition hexadecagon_r11 = hexadecagon_center.addOrReplaceChild("hexadecagon_r11", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -0.3978F, -2.0F, 2.0F, 0.7956F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.0F, -8.0F, 8.0F, -0.7854F, 0.0F, 0.0F));

		PartDefinition hexadecagon_r12 = hexadecagon_center.addOrReplaceChild("hexadecagon_r12", CubeListBuilder.create().texOffs(0, 10).addBox(-1.0F, -0.3978F, -2.0F, 2.0F, 0.7956F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.0F, -8.0F, 8.0F, 0.7854F, 0.0F, 0.0F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		hexadecagon_outer.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
		hexadecagon_inner.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
		hexadecagon_center.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
}